...
class ProjectViewModel : BaseViewModel() {
    ...
    private val projectResoitory by lazy { ProjectResoitory() }
    ...
    fun getProjectCategory() {
        ...
        launch(
            block = {
                val categoryList = projectResoitory.getProjectCategories()
                val checkedPosition = INITIAL_CHECKED
                val cid = categoryList[checkedPosition].id
                val pagination = projectResoitory.getProjectListCid(INITIAL_PAGE, cid)
    ...
    fun loadMorePorjectList(){
        ...
        launch(
            block = {
                ...
                val cid=categoryList[checkedPosition].id
                val pagination = projectResoitory.getProjectListCid(page+1, cid)
                page=pagination.curPage
